...
class block_recommended_courses_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('select', 'config_title_alignment', 
            get_string('config_title_alignment', 'block_recommended_courses'), $alignmentoptions);
        ...
        $mform->addElement('select', 'config_layout_mode', 
            get_string('config_layout_mode', 'block_recommended_courses'), $layoutmodes);
        ...
        $mform->addElement('select', 'config_image_fit', 
            get_string('config_image_fit', 'block_recommended_courses'), $imagefitmodes);
        ...
        $mform->addElement('select', 'config_image_height', 
            get_string('config_image_height', 'block_recommended_courses'), $imageheights);
        ...
        $mform->addElement('select', 'config_border_radius', 
            get_string('config_border_radius', 'block_recommended_courses'), $borderradius);
        ...
        $mform->addElement('select', 'config_animation_speed', 
            get_string('config_animation_speed', 'block_recommended_courses'), $animationspeeds);
        ...
        $mform->addElement('select', 'config_autoslide', 
            get_string('config_autoslide', 'block_recommended_courses'), $autoslide_options);
        ...
        $mform->addElement('autocomplete', 'config_courses', 
            get_string('select_courses', 'block_recommended_courses'), $courseslist, $options);
    }
}
