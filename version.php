...
$plugin->version   = 2025101010;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release   = '2.0.5';           // Human-readable version name - Enrolled courses and badge support.
